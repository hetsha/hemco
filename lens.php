...
<body>
    ...
    <div class="modal fade" id="lens">
        <div class="modal-dialog">
            <div class="modal-header">
            <!-- <i class="fa fa-window-close" aria-hidden="true"></i> -->
            <!-- <button type="button" class="btn-close fa fa-window-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                <!-- <svg width="1em" class="fa fa-window-close" data-bs-toggle="modal" data-bs-target="#lenscat" height="1em" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <i class="fa fa-window-close" data-bs-toggle="modal" data-bs-target="#lenscat"></i>
                <h1>Select Lens Type</h1>
                <i class="fa fa-window-close" data-bs-toggle="modal" data-bs-target="#lenscat"></i>
                <!-- <svg width="1em" class="fa fa-window-close" data-bs-toggle="modal" data-bs-target="#lenscat" height="1em" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
